...
const I18N = {
  en: {
    ...
    supplier_portal_subtitle: 'Track your purchase orders',
    shipment: 'Shipment',
    loaded_status: 'Loaded',
    awaiting_status: 'Awaiting Shipment',
    mark_as_loaded: 'Mark as Loaded',
    confirm_loaded: 'Confirm Loaded',
    marked_loaded_success: 'Order marked as loaded',
    driver_name: 'Driver Name',
    driver_phone: 'Driver Phone',
    truck_number: 'Truck Number',
    give_login_access: 'Give Login Access',
    revoke_login: 'Revoke Login',
    supplier_login_email: 'Login Email',
    supplier_login_password: 'Password (min 8 characters)',
    login_access_granted: 'Login access granted',
    login_revoked: 'Login access revoked',
  ...
  ar: {
    ...
    supplier_portal_subtitle: 'تتبع أوامر الشراء الخاصة بك',
    shipment: 'الشحنة',
    loaded_status: 'تم التحميل',
    awaiting_status: 'بانتظار الشحن',
    mark_as_loaded: 'تأكيد التحميل',
    confirm_loaded: 'تأكيد',
    marked_loaded_success: 'تم تأكيد تحميل الطلبية',
    driver_name: 'اسم السائق',
    driver_phone: 'هاتف السائق',
    truck_number: 'رقم الشاحنة',
    give_login_access: 'منح صلاحية الدخول',
    revoke_login: 'إلغاء صلاحية الدخول',
    supplier_login_email: 'بريد الدخول',
    supplier_login_password: 'كلمة المرور (٨ أحرف على الأقل)',
    login_access_granted: 'تم منح صلاحية الدخول',
    login_revoked: 'تم إلغاء صلاحية الدخول',
