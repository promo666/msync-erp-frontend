class MSyncApp {
  ...
  renderSidebar() {
    ...
    const items = [
      ...
      { id: 'products', icon: 'fa-boxes', label: t('nav_products'), roles: ['owner', 'admin', 'salesman', 'sales_supervisor'] },
      { id: 'new-sale', icon: 'fa-cash-register', label: t('nav_new_sale'), roles: ['owner', 'admin', 'salesman', 'sales_supervisor'] },
      ...
      { id: 'reports', icon: 'fa-chart-pie', label: t('nav_reports'), roles: ['owner', 'admin', 'sales_supervisor'] },
      ...
      { id: 'purchase-orders', icon: 'fa-dolly', label: t('nav_purchase_orders'), roles: ['owner', 'admin', 'sales_supervisor'] },
      { id: 'shops', icon: 'fa-store', label: t('nav_shops'), roles: ['owner', 'admin', 'salesman', 'sales_supervisor'] },
      { id: 'shop-visits', icon: 'fa-route', label: t('nav_shop_visits'), roles: ['owner', 'admin', 'salesman', 'sales_supervisor'] },
  ...
  navigate(page) {
    ...
    const titles = {
      ...
      'shop-visits': [t('nav_shop_visits'), 'Confirmed shop visits'],
    ...
    const renderers = {
      ...
      'shop-visits': () => this.renderShopVisits(),
